#!/bin/bash -l
#SBATCH --job-name=abl-45-shapley
#SBATCH -p YES
...
#
#   sbatch ablations/train_45_shapley_selection.sh
#   RESUME=1 sbatch ablations/train_45_shapley_selection.sh     # continue after the 24h wall clock
#   INSTALL_DEPS=1 sbatch ablations/train_45_shapley_selection.sh
