#!/bin/bash -l
#SBATCH --job-name=abl-180k10-piml
#SBATCH -p general
...
#SBATCH --mem=64G
#
# BASELINE for the 180 deg case: 180 deg coverage, every 10th view, physics loss ON.
#
...
#
#   sbatch ablations/train_180k10_piml.sh
#   RESUME=1 sbatch ablations/train_180k10_piml.sh     # continue after the 24h wall clock
#   INSTALL_DEPS=1 sbatch ablations/train_180k10_piml.sh
...
RUN_FOLDER=output/720_816_limited180_k10_PIML
ANGLE_START=0
...
WANDB_RUN_NAME="abl-180k10-piml"
# ────────────────────────────────────────────────────────────────────────────
