#!/bin/bash -l
#SBATCH --job-name=abl-180-shapley
#SBATCH -p YES
...
#SBATCH --mem=64G
#
# SHAPLEY ANGLE SELECTION at 180 deg.
#
...
#
#   sbatch ablations/train_180_shapley_selection.sh
#   RESUME=1 sbatch ablations/train_180_shapley_selection.sh     # continue after the 24h wall clock
#   INSTALL_DEPS=1 sbatch ablations/train_180_shapley_selection.sh
...
RUN_FOLDER=output/720_816_limited180_SHAPLEY_SELECTION
ANGLE_START=0
ANGLE_END=180
...
WANDB_RUN_NAME="abl-180-shapley"
# ────────────────────────────────────────────────────────────────────────────
