#!/bin/bash -l
#SBATCH --job-name=abl-45k10-nopiml
#SBATCH -p general
...
#SBATCH --mem=64G
#
# ABLATION of the physics loss at 45 deg coverage. Identical to
# train_45k10_piml.sh except physics_loss_weight = 0.
#
...
#
#   sbatch ablations/train_45k10_nopiml.sh
#   RESUME=1 sbatch ablations/train_45k10_nopiml.sh     # continue after the 24h wall clock
#   INSTALL_DEPS=1 sbatch ablations/train_45k10_nopiml.sh
...
RUN_FOLDER=output/720_816_limited45_k10_NONE_PIML
ANGLE_START=0
...
WANDB_RUN_NAME="abl-45k10-nopiml"
# ────────────────────────────────────────────────────────────────────────────
